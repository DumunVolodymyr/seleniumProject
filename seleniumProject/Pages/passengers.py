...
class Passengers():
    ...
    def enter_first_name(self):
        time.sleep(2)
        self.driver.find_element_by_xpath(self.firstName).send_keys('Володимир')
        time.sleep(1)

    def enter_last_name(self):
        self.driver.find_element_by_xpath(self.lastName).send_keys('Думин')
        time.sleep(1)
    ...
    def enter_email(self):
        time.sleep(1)
        self.driver.find_element_by_xpath(self.email).send_keys('dumyn@gmail.com')
        time.sleep(1)
